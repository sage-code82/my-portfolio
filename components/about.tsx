  ...
  return (
    ...
    >
      ...
      <p className="mb-4">
        ...
        <span className="font-medium">MERN stack</span>. I have decided to turn
        my passion for programming into a professional journey, embarking on a
        ...
        . Always eager to learn and continually enhance my skills through
